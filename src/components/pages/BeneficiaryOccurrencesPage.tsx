    ...
    <>
            ...
            <div className="space-y-2">
              {messages.map((item) => (
                ...
                >
                  ...
                  <p className="text-xs font-medium text-primary mt-1">#{item.occurrence_code}</p>
      ...
      >
        <DialogContent className="w-[calc(100%-2rem)] max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          {selectedMessage && (
            <div className="space-y-3">
              <p className="text-sm font-medium text-primary">Ocorrência #{selectedMessage.occurrence_code}</p>
